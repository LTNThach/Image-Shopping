<%-- 
    Document   : viewalbum
    Created on : Dec 29, 2015, 9:53:40 PM
    Author     : Thach
--%>
...
<html>
    ...
    <body>
        ...
        <div class="page-header">
            <h1 align="center" >${NomAlbum} of ${user.getNomUtilisateur()}</h1>
        </div>
        
        <c:if test="${ListPhoto.size() <= 0}">
            <h3 align="center">No image yet.</h3>
        </c:if>
        <c:if test="${ListPhoto.size() > 0}">
                ...
                <c:if test="${loginedUser != null}">
                    <div class="col-sm-4">
                        <div class="panel panel-success">    
                            ...
                            <c:if test="${loginedUser.getIDU() != user.getIDU()}">
