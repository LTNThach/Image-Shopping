<%-- 
    Document   : search
    Created on : Jan 4, 2016, 2:09:52 PM
    Author     : Thach
--%>
...
<html>
    ...
    <body>
        ...
        <c:if test="${ListPhoto.size() <= 0}">
            <h3 align="center">No image found.</h3>
        </c:if>
        <c:if test="${ListPhoto.size() > 0}">
            <div class="container">
                <div class="col-lg-4 col-lg-offset-9">
                    <div class="form-group">
                        <label class="control-label col-lg-3" for="text" style="color:#777777">Sort by:</label>
                        <div class="col-lg-6">
                            <select class="form-control" onChange="window.location.href=this.value">
                                <option value="Search?strSearch=${strSearch}&category=${category}&SortBy=NoSort">No Sort</option>
                                <option value="Search?strSearch=${strSearch}&category=${category}&SortBy=View">View</option>
                                <option value="Search?strSearch=${strSearch}&category=${category}&SortBy=Point">Point</option>
                                <option value="Search?strSearch=${strSearch}&category=${category}&SortBy=Like">Like</option>
                                <option value="Search?strSearch=${strSearch}&category=${category}&SortBy=Purchase">Purchase</option>
                            </select>
                        </div>
                    </div>
                </div>
